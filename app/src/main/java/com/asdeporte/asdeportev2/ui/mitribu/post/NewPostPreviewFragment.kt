...
import com.asdeporte.asdeportev2.databinding.FragmentNewPostPreviewBinding
import com.bumptech.glide.Glide

class NewPostPreviewFragment : Fragment() {

    private lateinit var binding: FragmentNewPostPreviewBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentNewPostPreviewBinding.inflate(inflater)
        return binding.root
    }
